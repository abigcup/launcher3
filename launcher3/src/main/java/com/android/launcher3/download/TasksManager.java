...
/**
 * Created by HuangJie on 2018/1/30.
 */
...
public class TasksManager {
    ...
    public String createShortcutPath(String name) {
        return FileDownloadUtils.getDefaultSaveRootPath() + "/shortcut/" + name + ".apk";
    }
    ...
    private static class TasksManagerDBOpenHelper extends SQLiteOpenHelper {
        public final static String DATABASE_NAME = LauncherFiles.DB_NAME_TASKS_MANAGER;
        public final static int DATABASE_VERSION = 2;

        public TasksManagerDBOpenHelper(Context context) {
            super(
                    LocalDBContext.Factory.newTasksManagerContext(context),
