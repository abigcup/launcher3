 ...
 * 库路径：/data/user/0/com.cyjh.huawei.launcher3/databases/launcher.db
 */
public class LauncherSettings {
    ...
    static interface BaseLauncherColumns extends ChangeLogColumns {
        ...
        /**
         * The gesture is an application created preset shortcut
         */
        public static final int ITEM_TYPE_PRESET_SHORTCUT = 2000;
