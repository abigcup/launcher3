...
public class LauncherProvider extends ContentProvider {
    ...
    synchronized public void loadDefaultFavoritesIfNecessary() {
        ...
        Log.d(TAG, "load Defalut Favorites configuration:" + configuration.toString());
        if (!configuration.isLoadedDefaultFavorites) {
            ...
            Log.d(TAG, "usingExternallyProvidedLayout:" + usingExternallyProvidedLayout);
            if ((mOpenHelper.loadFavorites(mOpenHelper.getWritableDatabase(), loader) <= 0)
                ...
                Log.d(TAG, "dont load default layout");
            }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        DatabaseHelper(Context context) {
            super(
                    LocalDBContext.Factory.newLauncherContext(context),
                    LauncherFiles.LAUNCHER_DB, null, DATABASE_VERSION
            );
            mContext = context;
        ...
        private void setFlagJustLoadedOldDb() {
            Log.d(TAG, "setFlagJustLoadedOldDb()");
            String spKey = LauncherAppState.getSharedPreferencesKey();
