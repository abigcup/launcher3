...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragListener {
    ...
    private static final int INSTALL_SHORTCUT = R.id.action_install_shortcut;
    ...
    public LauncherAccessibilityDelegate(Launcher launcher) {
        ...
        mActions.put(INSTALL_SHORTCUT, new AccessibilityAction(INSTALL_SHORTCUT,
                launcher.getText(R.string.shortcut_target_label)));
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info) {
        ...
        if (ShortcutDropTarget.supportsDrop(host.getContext(), item)) {
            info.addAction(mActions.get(INSTALL_SHORTCUT));
        }
    ...
    public boolean performAction(final View host, final ItemInfo item, int action) {
        ...
        try {
            Log.i("performAction", item.title.toString() + " act=" + action);
        }catch (Exception ex){
        ...
        } else if (action == INSTALL_SHORTCUT) {
            ShortcutDropTarget.startInstallShortcut(item, mLauncher);
            return true;
        } else if (action == MOVE) {
