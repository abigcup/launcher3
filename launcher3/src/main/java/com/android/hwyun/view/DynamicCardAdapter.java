...
public class DynamicCardAdapter extends BaseAdapter {
    ...
    public DynamicCardAdapter(Context context, List<CardInfo> list,AdapterICallback callback) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view2 = LayoutInflater.from(this.mContext).inflate(R.layout.intelligent_show_item_layout, viewGroup, false);
