...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    private boolean enableHotSeatShowText;
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        enableHotSeatShowText = grid.inv.enableHotSeatShowText;
    ...
    public boolean addViewToCellLayout(View child, int index, int childId, LayoutParams params,
        ...
        if (child instanceof BubbleTextView) {
            ...
            //（这个是原生桌面的逻辑：hotseat的图标不显示应用名称）当前需求可能需要显示所以注释掉
            bubbleChild.setTextVisibility(!mIsHotseat || enableHotSeatShowText);
        }
    ...
    */
    ...
    int[] performReorder(int pixelX, int pixelY, int minSpanX, int minSpanY, int spanX, int spanY,
        ...
        //这里第一个判断是后添加的
        //folder.replaceFolderWithFinalItem和performReorder方法存在冲突，这里将使用临时位置的标记位置为false
        //否则桌面存在错乱
        if (mode == MODE_ACCEPT_DROP || ((mode == MODE_ON_DROP || !foundSolution) && !DESTRUCTIVE_REORDER)) {
